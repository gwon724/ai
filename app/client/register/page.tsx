...
import { LOGO_B64, registerUser, FONT } from "@/lib/store"; // LOGO_B64 added
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#E8EDFB", padding: "40px 16px", fontFamily: font }}>
      <div style={{ textAlign: "center", marginBottom: "28px" }}>
        <img src={LOGO_B64} alt="EMFRONTIER LAB" width={60} height={60} style={{ objectFit: "contain", margin: "0 auto 8px", display: "block" }} />
